<?php 
	...
	function usuario(){
		$clie = query("SELECT * FROM clientes ");
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								<a href="index.php">Administración de Usuarios</a>
							</li>
							<li>
...
<table style="width:100%; top:0; left:0; position: fixed; background-color:#ddd; height: 50px; z-index:999;">		
	...
	?>
		<table style="position:relative;width:90%; margin: 60px auto 0 auto; ">
			...
			<tbody>
				<?php 
					while($r = mysqli_fetch_array($clien)):
				?>
					<tr>
						<td><?php echo $r['id'];?></td>
	...
	?>
		<div class="col-md-12" style="margin-top: 20px;">
			<div class="alert alert-danger">No hay clientes</div>
		</div>
	<?php } ?>
	<!-- Footer -->
