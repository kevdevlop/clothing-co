<?php 
	...
	function catalogo($idpro){
		$cat = query("SELECT * FROM products WHERE id = ".$idpro.";");
...
<body class="animsition">
	...
	<?php 
	 	$pro = catalogo($idpro);
	 	if(!is_null($pro)):
	 	$row = mysqli_fetch_array($pro,MYSQLI_ASSOC);
	?>
				...
				<tr>
					...
					<td colspan="5">
						...
						<form action="update.php" method="post" enctype="multipart/form-data" >
							...
							?>	
								<img src="<?php echo $row['image'];?>" alt="" style="width:100px;">
							<?php 
								endif; 
							?>
							<br>
